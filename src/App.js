    ...
    const addSampleRow = () => {
        ...
        for (let i = 0; i < 100; i++) {
            ...
            arr.push((<tr>
                ...
                <td className="cs-primary_color cs-p0 cs-p-t10 cs-p-b">&nbsp;{q}</td>
        ...
        <>
            ...
            >
                <Modal.Header closeButton className='py-1 px-2'>
                    ...
                    <Button  size='sm' variant="secondary" onClick={() => handleDownload(document.getElementById('tm_download_section'))}>Download</Button>
                    </Modal.Title>
                </Modal.Header>

                <Modal.Body className='p-0'>
                    <div className="cs-container style1 pt-1 ">
                        <div className="cs-invoice cs-style1 border py-2 px-4" >
                                    ...
                                    <table>
                                        <thead>
                                            <tr className="cs-border_bottom style_1">
                                                <th className="cs-width_6 cs-bold cs-primary_color">Item</th>
                                                <th className="cs-primary_color cs-bold ">Unit</th>
                                                <th className="cs-primary_color cs-bold ">UP</th>
